...
class TestClient:
    def test_search_request(self):
        actual = Client._search_request(
            "api_key", "decimal system", "dewey", media_code="BK"
        )
        expected = {
            "APIKey": "api_key",
            "SearchItems": {
                "SearchItem": [
                    {"SearchField": "Keywords", "SearchTerms": "decimal system"},
                    {"SearchField": "Author", "SearchTerms": "dewey"},
        ...
        expected = {
            ...
            "SearchItems": {
                "SearchItem": [
                    {"SearchField": "Keywords", "SearchTerms": "decimal system"},
                    {"SearchField": "Author", "SearchTerms": "dewey"},
                    {"SearchField": "BranchID", "SearchTerms": "AMKPL"},
                    {"SearchField": "MediaCode", "SearchTerms": "BK"},
                    {"SearchField": "Language", "SearchTerms": "Chinese"},
                ]
            },
            "Modifiers": {
                "SortSchema": "PUBDATE",
